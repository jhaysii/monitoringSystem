          ...
          <div class="col-sm-7 wow fadeInDown">
            ...
            <div class="col-md-8">
              ...
              <ul class="list-group">
                ...
                <!-- <li class="list-group-item text-right"><span class="pull-left">Test</span><input class="StudeasdfntID" type="text" id="asdf"></li> -->
                <li class="list-group-item text-right"><span class="pull-left">IDNO</span><input class="StudentID" type="text" id="StudentID" onkeypress="anotherFunction()"></li>
